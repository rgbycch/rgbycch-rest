...
ActiveRecord::Schema.define(version: 20151213213348) do
  ...
  create_table "team_player", id: false, force: :cascade do |t|
    t.integer "team_id"
    t.integer "player_id"
  end

  add_index "team_player", ["team_id", "player_id"], name: "index_team_player_on_team_id_and_player_id"
