...
describe Api::V1::MatchDayPlayersController, :type => :controller do
  ...
  describe "GET #index" do
    ...
    context "User is logged in" do
      ...
      it "returns 3 match-day players from the database" do
  ...
  describe "GET #show" do
    ...
    context "User is logged in" do
      ...
      context "User requests a match-day player which is present" do
      ...
      context "User requests a match-day player which is not present" do
  ...
  describe "POST #create" do
    ...
    context "User is logged in" do
      ...
      context "when a match-day player is successfully created" do
      ...
      context "when is not created" do
        ...
        it "renders the json errors on why the match-day player could not be created" do
          match_day_player_response = json_response
  ...
  describe "PUT/PATCH #update" do
    ...
    context "User is logged in" do
      ...
      context "when is successfully updated" do
        ...
        it "renders the json representation for the updated match-day player" do
          match_day_player_response = json_response[:match_day_player]
      ...
      context "when is not updated" do
        ...
        it "renders the json errors on why the match-day player could not be updated" do
          match_day_player_response = json_response
          expect(match_day_player_response[:errors][:rating]).to include "must be greater than or equal to 0"
        end
